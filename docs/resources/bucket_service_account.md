...
- `name` (String) Name of the service account. Changing this forces a new resource to be created.
...
- `region` (String) Region where the service account will be created. Changing this forces a new resource to be created.
